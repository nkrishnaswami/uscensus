...
from uscensus.util.textindex import TextIndex, VariableFields
...
class AsyncCensusDataEndpoint:
    ...
    async def create(key: str,
        ...
        self.session = session                 # httpx.AsyncClient
...
class CensusDataEndpoint:
    """A single census endpoint, with metadata about queryable variables
    and geography.
    """

    def __init__(self,
                 impl: AsyncCensusDataEndpoint) -> None:
